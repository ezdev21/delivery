<template>
  <button @click="addToCart" class="cursor-pointer rounded">
    <svg xmlns="http://www.w3.org/2000/svg" class="text-first h-6 w-6" :class="[productInCart? 'text-green-500':'text-pink-500']" fill="none" viewBox="0 0 24 24" stroke="currentColor">
